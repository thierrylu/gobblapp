...
@interface FAAboutViewController ()

@end

@implementation FAAboutViewController
...
- (void)viewDidLoad
{
    ...
    [_termWebView loadHTMLString:[NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"AboutUs.html" ofType:nil] encoding:NSUTF8StringEncoding error:NULL] baseURL:nil];
    
    self.topBarItem.title = @"About this version";
